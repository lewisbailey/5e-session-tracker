...
assert(!app.includes("Confirm maximum HP"),"Manual maximum-HP prompt should not be present");
assert(publicData.includes("ID_INTERNAL_ABILITY_SCORE_IMPROVEMENT_FEAT_${ability}"),"Ability-score mechanics are missing");
